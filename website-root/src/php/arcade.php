...
<main role="main">
  <section class="mdev-main-wrapper">
    ...
    <section class="laser-maze-module">
      ...
      <div>
        <p>Star in your own laser adventure.  Like a spy, you will duck, crawl or step over the laser beams to complete the mission.  Play as an individual or play with a friend! Sound effects and video cpturing will make you want to keep coming back.</p>
        <ul>
    ...
    <section class="trampoline-ninja-module">
      ...
      <div>
        <p>The idea is simple - smash as many ninja stars as you can in 90 seconds while jumping on an interactive trampoline. This single or multi-player game, equipped with special effects and animations is perfect for all ages.</p>
        <ul>
          <li class="rules-safety"><a href="#"><span><!-- icon --></span> Rules &amp; Safety</a></li>
          <li><a href="#" class="cta-button">Book Now</a></li>
        </ul>
